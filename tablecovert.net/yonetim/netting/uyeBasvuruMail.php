...
$mail->Subject = 'Imex Üyelik Başvurusu'; //Mail konusu
$isim=ucfirst($name);
...
'
    <html>
        ...
        <body>
            <h1>Imex Üyelik Başvurusu</h1>
            <p>Sayın : '.$isim." ".$soyisim." "." Üyelik başvurunuz alınmıştır. Üyeliğiniz onaylandığında mail yolu ile bilgilendirileceksiniz.".'</p>
            <p>Şifreniz : '.$pass.'</p>
            <p></p>
            <p>www.imexup.com</p>
        </body>
