...
$menusor=$db->prepare("SELECT * FROM hizmetlerimiz where menu_id=:menu_id");
...
<div class="right_col" role="main">
          ...
          <div class="x_content">
            ...
            <form action="../netting/islem.php" enctype="multipart/form-data" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <?php } else {?>
                    ...
                    <img width="200"  src="../../<?php echo $menucek['menu_resim']; ?>">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="file" id="first-name"  name="menu_resim"  class="form-control col-md-7 col-xs-12">
                </div>
              </div>

               <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Video Full Linki<span class="required"></span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="menu_video" value="<?php echo $menucek['menu_video'] ?>" class="form-control col-md-7 col-xs-12">
                </div>
              </div>

              <input type="hidden" name="eski_yol" value="<?php echo $menucek['menu_resim']; ?>">

              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Sayfa Linki <span class="required"></span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="" id="first-name" name="kullanici_tc" disabled="" value="http://www.<?php echo $_SERVER['HTTP_HOST']; ?>/hizmetlerimiz-<?php echo seo($menucek['menu_ad']) ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
 ...
 <!--              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Hizmet Url <span class="required"></span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
