            ...
            <div class="x_title">
              ...
              <div class="x_content">
                ...
                <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">İletişim Sayfası GELEN Mail Adresi<span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="first-name" placeholder="İletişim formundan gönderilen mailler bu mail adresine gider." name="ayar_gelenmail" value="<?php echo $ayarcek['ayar_gelenmail']; ?>" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
